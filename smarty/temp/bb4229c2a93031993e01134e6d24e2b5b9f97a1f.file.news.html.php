<?php /* Smarty version Smarty3-b8, created on 2012-06-11 10:27:09
         compiled from "D:\APMServ5.2.6\www\htdocs\shehuahk\backadmin/Template/news.html" */ ?>
<?php /*%%SmartyHeaderCode:230674fd5577d9c5b24-05751867%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bb4229c2a93031993e01134e6d24e2b5b9f97a1f' => 
    array (
      0 => 'D:\\APMServ5.2.6\\www\\htdocs\\shehuahk\\backadmin/Template/news.html',
      1 => 1305862376,
    ),
  ),
  'nocache_hash' => '230674fd5577d9c5b24-05751867',
  'function' => 
  array (
  ),
...
" /><?php }?></td>
						<td align="left"><?php echo $_smarty_tpl->getVariable('pso')->value['title'];?>
</td>
						<td><?php echo $_smarty_tpl->getVariable('pso')->value['taxis'];?>
</td>
						<td><?php if ($_smarty_tpl->getVariable('pso')->value['is_view']=='Y'){?>显示<?php }else{ ?>隐藏<?php }?></td>
						<td><?php echo smarty_modifier_date_format($_smarty_tpl->getVariable('pso')->value['uptime'],"%Y-%m-%d %H:%M:%S");?>
</td>
...
" class="act_1_5" title="删除"></a><?php }?></td>
					...
					<?php }} else { ?>
					<tr><td colspan="7" class="else">当前没有新闻 , <a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'add','DEL'=>'id'),$_smarty_tpl->smarty,$_smarty_tpl);?>
">点击添加新闻</a></td></tr>
					<?php } ?>
				</table>
				<div class="select">
