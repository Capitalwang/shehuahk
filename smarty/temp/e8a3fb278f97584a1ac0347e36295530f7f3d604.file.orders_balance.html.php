<?php /* Smarty version Smarty3-b8, created on 2012-05-23 15:52:46
         compiled from "D:\APMServ5.2.6\www\htdocs\shehuahk\backadmin/Template/orders_balance.html" */ ?>
<?php /*%%SmartyHeaderCode:214464fbc974e6aab34-84855735%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e8a3fb278f97584a1ac0347e36295530f7f3d604' => 
    array (
      0 => 'D:\\APMServ5.2.6\\www\\htdocs\\shehuahk\\backadmin/Template/orders_balance.html',
      1 => 1277022850,
    ),
  ),
  'nocache_hash' => '214464fbc974e6aab34-84855735',
  'function' => 
  array (
  ),
...
" /></td>
 ...
 元</td>
		...
		<tr>
			<td align="right" class="Need">订单余款</td>
			<td><?php echo sprintf('%.2f',$_smarty_tpl->getVariable('orders')->value['price']-$_smarty_tpl->getVariable('orders')->value['earnest']);?>
 元</td>
 ...
 元</td>
		...
		<tr>
			...
			<?php if ($_smarty_tpl->getVariable('proxy')->value['money']>=($_smarty_tpl->getVariable('orders')->value['price']-$_smarty_tpl->getVariable('orders')->value['earnest'])){?>
				<input type="submit" value=" 确 认 扣除余款 " />
			<?php }else{ ?>
				<b style="color:#F00">购买人金额 不足支付 订单的余款</b>
			<?php }?>
			</th>
		</tr>
		<tr>
...
?>
					<tr align="center">
						...
						<td><?php if ($_smarty_tpl->getVariable('pso')->value['status']=='Y'){?><?php if ($_smarty_tpl->getVariable('pso')->value['is_arrival']=='Y'){?>到货<?php }else{ ?>未到<?php }?><?php }?></td>
						<td class="action"><a href="javascript:;" onclick="show_detail(this , '<?php echo $_smarty_tpl->getVariable('pso')->value['id'];?>
' , 11)" class="act_3_10" title="产品详情"></a></td>
					</tr>
					<?php }} ?>
				</table>
			</td>
