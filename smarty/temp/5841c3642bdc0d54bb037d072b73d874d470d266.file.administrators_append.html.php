<?php /* Smarty version Smarty3-b8, created on 2015-04-30 17:14:06
         compiled from "D:\www\shehuahk\backadmin/Template/administrators_append.html" */ ?>
<?php /*%%SmartyHeaderCode:237315541f25e9e68c1-70362972%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5841c3642bdc0d54bb037d072b73d874d470d266' => 
    array (
      0 => 'D:\\www\\shehuahk\\backadmin/Template/administrators_append.html',
      1 => 1305853532,
    ),
  ),
  'nocache_hash' => '237315541f25e9e68c1-70362972',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_function_checked')) include 'D:\www\shehuahk\smarty\plugins\function.checked.php';
...
" method="post">
				<table width="100%" border="0" cellspacing="1" cellpadding="0" id="tab_show">
					<tr><th colspan="2"><?php if ($_smarty_tpl->getVariable('get')->value['action']!='edit'){?>添加管理员<?php }else{ ?>编辑管理员<?php }?></th></tr>
					<tr>
...
>密码</td>
						<td>
							...
							<span class="Hint">注：密码不能少于6个字符. <?php if ($_smarty_tpl->getVariable('get')->value['action']=='edit'){?><b>不填写表示不更改管理员的密码</b><?php }?></span>
						</td>
					</tr>
					<tr>
