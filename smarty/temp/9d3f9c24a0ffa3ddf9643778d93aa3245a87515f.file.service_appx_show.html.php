<?php /* Smarty version Smarty3-b8, created on 2013-03-21 17:19:59
         compiled from "D:\APMServ5.2.6\www\htdocs\shehuahk\backadmin/Template/service_appx_show.html" */ ?>
<?php /*%%SmartyHeaderCode:7530514ad0bf5fe3d7-99737844%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9d3f9c24a0ffa3ddf9643778d93aa3245a87515f' => 
    array (
      0 => 'D:\\APMServ5.2.6\\www\\htdocs\\shehuahk\\backadmin/Template/service_appx_show.html',
      1 => 1305853533,
    ),
  ),
  'nocache_hash' => '7530514ad0bf5fe3d7-99737844',
  'function' => 
  array (
  ),
		...
		<div class="append">
			<table width="100%" border="0" cellspacing="1" cellpadding="0" id="tab_show">
				...
				<tr class="NO_TAB_SHOW">
					<td align="right">客服账号</td>
					<td><?php echo $_smarty_tpl->getVariable('service')->value['account'];?>
</td>
					<td align="right">真实姓名</td>
					<td><?php echo $_smarty_tpl->getVariable('service')->value['name'];?>
</td>
					<td align="right">昵称</td>
					<td><?php echo $_smarty_tpl->getVariable('service')->value['nickname'];?>
</td>
					<td align="right">编号</td>
					<td><?php echo $_smarty_tpl->getVariable('service')->value['number'];?>
</td>
					<td width="20%">
...
" <?php echo smarty_function_CLASS_COLOR(array('service'=>$_smarty_tpl->getVariable('get')->value['open'],'appx_add'=>$_smarty_tpl->getVariable('get')->value['action'],'CLASS'=>'this'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>添加附件</a></li><?php }?>
...
" <?php echo smarty_function_CLASS_COLOR(array('service'=>$_smarty_tpl->getVariable('get')->value['open'],'appx_show'=>$_smarty_tpl->getVariable('get')->value['action'],'CLASS'=>'this'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>附件管理</a></li><?php }?>
							</ul>
							<span class="clear"></span>
						</div>
...
" class="act_1_5" title="删除"></a><?php }?></td>
								...
								<?php }} else { ?>
								<tr><td colspan="9" class="else">当前客服没有附件 , <a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'appx_add'),$_smarty_tpl->smarty,$_smarty_tpl);?>
">点击为该客服添加附件</a></td></tr>
								<?php } ?>
							</table>
