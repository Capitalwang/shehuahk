<?php /* Smarty version Smarty3-b8, created on 2012-04-30 10:19:06
         compiled from "D:\APMServ5.2.6\www\htdocs\2011best\shehuahk\backadmin/Template/proxy_group.html" */ ?>
<?php /*%%SmartyHeaderCode:216004f9df69acdc246-34244354%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4e42450cf7f74cd60a5d4652fa6b3185d318977f' => 
    array (
      0 => 'D:\\APMServ5.2.6\\www\\htdocs\\2011best\\shehuahk\\backadmin/Template/proxy_group.html',
      1 => 1305853533,
    ),
  ),
  'nocache_hash' => '216004f9df69acdc246-34244354',
  'function' => 
  array (
  ),
...
if (!is_callable('smarty_modifier_default')) include 'D:\APMServ5.2.6\www\htdocs\2011best\shehuahk\smarty\plugins\modifier.default.php';
...
" /><?php }?></td>
						...
						<td><?php echo smarty_modifier_default($_smarty_tpl->getVariable('pso')->value['rebate'],0);?>
 %</td>
						<td><?php if ($_smarty_tpl->getVariable('pso')->value['is_offer']=='Y'){?><b style="color:#093">支持</b><?php }else{ ?><b style="color:#F00">不支持</b><?php }?></td>
						<td><?php echo $_smarty_tpl->getVariable('pso')->value['taxis'];?>
</td>
...
" class="act_1_5" title="删除"></a><?php }?></td>
					...
					<?php }} else { ?>
					<tr><td colspan="9" class="else">当前没有代理组 , <a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'add','DEL'=>'ALL'),$_smarty_tpl->smarty,$_smarty_tpl);?>
">点击添加代理组</a></td></tr>
					<?php } ?>
				</table>
				<div class="select">
...
>按 时间 (↓) 排序</option>
					<option value="ORDER=tais_UP" <?php echo smarty_function_selected(array('val'=>$_smarty_tpl->getVariable('get')->value['ORDER'],'str'=>'tais_UP'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>按 排序 (↑) 排序</option>
					<option value="ORDER=tais_Dn" <?php echo smarty_function_selected(array('val'=>$_smarty_tpl->getVariable('get')->value['ORDER'],'str'=>'tais_Dn'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>按 排序 (↓) 排序</option>
				</select>
			</div>
			<?php }?>
