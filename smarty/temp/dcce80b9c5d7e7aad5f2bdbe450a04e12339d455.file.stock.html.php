<?php /* Smarty version Smarty3-b8, created on 2012-05-02 20:01:32
         compiled from "D:\APMServ5.2.6\www\htdocs\shehuahk\backadmin/Template/stock.html" */ ?>
<?php /*%%SmartyHeaderCode:61144fa1221c507763-18122805%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dcce80b9c5d7e7aad5f2bdbe450a04e12339d455' => 
    array (
      0 => 'D:\\APMServ5.2.6\\www\\htdocs\\shehuahk\\backadmin/Template/stock.html',
      1 => 1305853533,
    ),
  ),
  'nocache_hash' => '61144fa1221c507763-18122805',
  'function' => 
  array (
  ),
...
" /><?php }?></td>
						<td align="left"><?php echo $_smarty_tpl->getVariable('pso')->value['address'];?>
</td>
						<td><?php echo $_smarty_tpl->getVariable('pso')->value['principal'];?>
</td>
						<td><?php echo $_smarty_tpl->getVariable('pso')->value['tel'];?>
</td>
						<td><?php echo $_smarty_tpl->getVariable('pso')->value['mobile'];?>
</td>
						<td><?php echo $_smarty_tpl->getVariable('pso')->value['fax'];?>
</td>
...
" class="act_1_5" title="删除"></a><?php }?></td>
					...
					<?php }} else { ?>
					<tr><td colspan="10" class="else">当前没有库存地址 , <a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'add','DEL'=>'id'),$_smarty_tpl->smarty,$_smarty_tpl);?>
">点击添加库存地址</a></td></tr>
					<?php } ?>
				</table>
				<div class="select">
