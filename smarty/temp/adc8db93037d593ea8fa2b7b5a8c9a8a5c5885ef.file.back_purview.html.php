<?php /* Smarty version Smarty3-b8, created on 2011-05-25 16:28:47
         compiled from "D:\htdocs\yulog.net.shehua\backadmin/Template/back_purview.html" */ ?>
<?php /*%%SmartyHeaderCode:308484ddcbdbf115be5-08798319%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'adc8db93037d593ea8fa2b7b5a8c9a8a5c5885ef' => 
    array (
      0 => 'D:\\htdocs\\yulog.net.shehua\\backadmin/Template/back_purview.html',
      1 => 1305853533,
    ),
  ),
  'nocache_hash' => '308484ddcbdbf115be5-08798319',
  'function' => 
  array (
  ),
...
" <?php echo smarty_function_CLASS_COLOR(array('back_purview'=>$_smarty_tpl->getVariable('get')->value['open'],'add'=>$_smarty_tpl->getVariable('get')->value['action'],'CLASS'=>'this'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>添加后台权限</a></li>
...
" <?php echo smarty_function_CLASS_COLOR(array('back_purview'=>$_smarty_tpl->getVariable('get')->value['open'],'show'=>$_smarty_tpl->getVariable('get')->value['action'],'CLASS'=>'this'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>后台权限管理</a></li>
			</ul>
...
" class="act_1_5" title="删除"></a><?php }else{ ?>-<?php }?></td>
					...
					<?php }} else { ?>
					<tr><td colspan="7" class="else">当前没有后台权限 , <a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'add','DEL'=>'id'),$_smarty_tpl->smarty,$_smarty_tpl);?>
">点击添加后台权限</a></td></tr>
					<?php } ?>
				</table>
				<div class="select">
