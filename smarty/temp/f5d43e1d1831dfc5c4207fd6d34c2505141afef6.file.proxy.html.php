<?php /* Smarty version Smarty3-b8, created on 2015-08-13 15:07:10
         compiled from "D:\www\shehuahk\backadmin/Template/proxy.html" */ ?>
<?php /*%%SmartyHeaderCode:2161755cc421e495356-98459848%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f5d43e1d1831dfc5c4207fd6d34c2505141afef6' => 
    array (
      0 => 'D:\\www\\shehuahk\\backadmin/Template/proxy.html',
      1 => 1439449626,
    ),
  ),
  'nocache_hash' => '2161755cc421e495356-98459848',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
)); /*/%%SmartyHeaderCode%%*/?>
<?php if (!is_callable('smarty_modifier_default')) include 'D:\www\shehuahk\smarty\plugins\modifier.default.php';
...
" />
					...
					<input name='info' type="text" style="width:250px" value="<?php echo smarty_modifier_default($_smarty_tpl->getVariable('get')->value['info'],'账号/姓名/昵称/编号/公司');?>
" onfocus="Pro_query(this,'账号/姓名/昵称/编号/公司')" />
...
" /><?php }?></td>
						<td align="left"><?php echo smarty_function_brite_spot(array('query'=>$_smarty_tpl->getVariable('get')->value['info'],'str'=>$_smarty_tpl->getVariable('pso')->value['account']),$_smarty_tpl->smarty,$_smarty_tpl);?>
</td>
						<td align="left"><?php echo smarty_function_brite_spot(array('query'=>$_smarty_tpl->getVariable('get')->value['info'],'str'=>$_smarty_tpl->getVariable('pso')->value['name']),$_smarty_tpl->smarty,$_smarty_tpl);?>
</td>
						<td align="left"><?php echo smarty_function_brite_spot(array('query'=>$_smarty_tpl->getVariable('get')->value['info'],'str'=>$_smarty_tpl->getVariable('pso')->value['nickname']),$_smarty_tpl->smarty,$_smarty_tpl);?>
</td>
						<td><?php echo smarty_function_brite_spot(array('query'=>$_smarty_tpl->getVariable('get')->value['info'],'str'=>$_smarty_tpl->getVariable('pso')->value['number']),$_smarty_tpl->smarty,$_smarty_tpl);?>
</td>
						<td align="left"><?php echo smarty_function_brite_spot(array('query'=>$_smarty_tpl->getVariable('get')->value['info'],'str'=>$_smarty_tpl->getVariable('pso')->value['company_name']),$_smarty_tpl->smarty,$_smarty_tpl);?>
</td>
						<td align="left"><?php echo $_smarty_tpl->getVariable('pso')->value['mag'];?>
</td>
						<td align="left"><?php echo $_smarty_tpl->getVariable('pso')->value['group'];?>
</td>
						<td align="left"><?php echo $_smarty_tpl->getVariable('pso')->value['gmag'];?>
</td>
						<td><?php echo smarty_modifier_date_format($_smarty_tpl->getVariable('pso')->value['login_time'],"%Y-%m-%d %H:%M:%S");?>
</td><!-- ../diamind/home-search-<?php echo $_smarty_tpl->getVariable('pso')->value['id'];?>
-<?php echo $_smarty_tpl->getVariable('pso')->value['number'];?>
.html -->
						<td><a href="../diamind/?open=home&action=search&page=1&token=<?php echo $_smarty_tpl->getVariable('pso')->value['id'];?>
&nid=<?php echo $_smarty_tpl->getVariable('pso')->value['number'];?>
" target="_blank">进入</a></td>
						<td class="action"><?php if ($_smarty_tpl->getVariable('BTP')->value[$_smarty_tpl->getVariable('get')->value['open']]['log']){?><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'log','id'=>$_smarty_tpl->getVariable('pso')->value['id']),$_smarty_tpl->smarty,$_smarty_tpl);?>
" class="act_5_7" title="日志"></a><?php }?></td>
						<td class="action"><?php if ($_smarty_tpl->getVariable('BTP')->value[$_smarty_tpl->getVariable('get')->value['open']]['money']){?><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'money','id'=>$_smarty_tpl->getVariable('pso')->value['id']),$_smarty_tpl->smarty,$_smarty_tpl);?>
" class="act_3_11" title="财务"></a><?php }?></td>
						<td class="action"><?php if ($_smarty_tpl->getVariable('BTP')->value[$_smarty_tpl->getVariable('get')->value['open']]['proxy_appx_show']){?><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'proxy_appx_show','id'=>$_smarty_tpl->getVariable('pso')->value['id']),$_smarty_tpl->smarty,$_smarty_tpl);?>
" class="act_1_8" title="附件"></a><?php }?></td>
						<td class="action"><?php if ($_smarty_tpl->getVariable('BTP')->value[$_smarty_tpl->getVariable('get')->value['open']]['proxy_nab']){?><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'proxy_nab','id'=>$_smarty_tpl->getVariable('pso')->value['id']),$_smarty_tpl->smarty,$_smarty_tpl);?>
" class="act_4_12" title="代理通讯录"></a><?php }?></td>
...
" class="act_1_5" title="删除"></a><?php }?></td>
					...
					<?php }} else { ?>
					<tr><td colspan="14" class="else">当前没有代理 , <a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'add','DEL'=>'ALL'),$_smarty_tpl->smarty,$_smarty_tpl);?>
">点击添加代理</a></td></tr>
					<?php } ?>
				</table>
				<div class="select">
				...
				<?php }?>
				<?php if ($_smarty_tpl->getVariable('BTP')->value['proxy_sms']['add']){?><input value="代理群发手机短信" type="button" onclick="add_cart('id[]',this,'<?php echo smarty_function_write_url(array('open'=>'proxy_sms','action'=>'add'),$_smarty_tpl->smarty,$_smarty_tpl);?>
')" /><?php }?>
				</div>
			</form>
