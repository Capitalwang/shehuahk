<?php /* Smarty version Smarty3-b8, created on 2012-09-20 13:24:28
         compiled from "D:\APMServ5.2.6\www\htdocs\shehuahk\backadmin/Template/proxy_appx_show.html" */ ?>
<?php /*%%SmartyHeaderCode:18865505aa88cea9727-81914253%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '30956d3b210209fee615d0739154627b3b172bac' => 
    array (
      0 => 'D:\\APMServ5.2.6\\www\\htdocs\\shehuahk\\backadmin/Template/proxy_appx_show.html',
      1 => 1305853533,
    ),
  ),
  'nocache_hash' => '18865505aa88cea9727-81914253',
  'function' => 
  array (
  ),
				...
				<tr class="NO_TAB_SHOW">
					...
					<td width="20%">
						<div class="Nav" style="margin:0; padding:0">
							<ul>
								<?php if ($_smarty_tpl->getVariable('BTP')->value[$_smarty_tpl->getVariable('get')->value['open']]['proxy_appx_add']){?><li><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'proxy_appx_add','DEL'=>'appxid'),$_smarty_tpl->smarty,$_smarty_tpl);?>
" <?php echo smarty_function_CLASS_COLOR(array('proxy_appx_add'=>$_smarty_tpl->getVariable('get')->value['action'],'CLASS'=>'this'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>添加附件</a></li><?php }?>
								<?php if ($_smarty_tpl->getVariable('BTP')->value[$_smarty_tpl->getVariable('get')->value['open']]['proxy_appx_show']){?><li><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'proxy_appx_show','DEL'=>'appxid'),$_smarty_tpl->smarty,$_smarty_tpl);?>
" <?php echo smarty_function_CLASS_COLOR(array('proxy_appx_show'=>$_smarty_tpl->getVariable('get')->value['action'],'CLASS'=>'this'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>附件管理</a></li><?php }?>
							</ul>
							<span class="clear"></span>
						</div>
				...
				<tr class='NO_TAB_SHOW'>
					<td colspan="9">
						<form action="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'proxy_appx_del'),$_smarty_tpl->smarty,$_smarty_tpl);?>
" method="post">
...
?>
								<tr>
									<td align="center"><?php if ($_smarty_tpl->getVariable('BTP')->value[$_smarty_tpl->getVariable('get')->value['open']]['proxy_appx_del']){?><input type="checkbox" name="appxid[]" value="<?php echo $_smarty_tpl->getVariable('pso')->value['id'];?>
" /><?php }?></td>
									...
									<td class="action" align="center"><?php if ($_smarty_tpl->getVariable('BTP')->value[$_smarty_tpl->getVariable('get')->value['open']]['proxy_appx_down']){?><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'proxy_appx_down','appxid'=>$_smarty_tpl->getVariable('pso')->value['id']),$_smarty_tpl->smarty,$_smarty_tpl);?>
" class="act_4_7" title="附件"></a><?php }?></td>
									<td class="action" align="center"><?php if ($_smarty_tpl->getVariable('BTP')->value[$_smarty_tpl->getVariable('get')->value['open']]['proxy_appx_edit']){?><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'proxy_appx_edit','appxid'=>$_smarty_tpl->getVariable('pso')->value['id']),$_smarty_tpl->smarty,$_smarty_tpl);?>
" class="act_5_8" title="编辑"></a><?php }?></td>
									<td class="action" align="center"><?php if ($_smarty_tpl->getVariable('BTP')->value[$_smarty_tpl->getVariable('get')->value['open']]['proxy_appx_del']){?><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'proxy_appx_del','appxid'=>$_smarty_tpl->getVariable('pso')->value['id']),$_smarty_tpl->smarty,$_smarty_tpl);?>
" class="act_1_5" title="删除"></a><?php }?></td>
								</tr>
								<?php }} else { ?>
								<tr><td colspan="9" class="else">当前代理没有附件 , <a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'proxy_appx_add'),$_smarty_tpl->smarty,$_smarty_tpl);?>
">点击为该代理添加附件</a></td></tr>
								<?php } ?>
							</table>
