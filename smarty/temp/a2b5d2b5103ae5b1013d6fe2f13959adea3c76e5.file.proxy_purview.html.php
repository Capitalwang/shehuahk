<?php /* Smarty version Smarty3-b8, created on 2011-05-25 16:28:32
         compiled from "D:\htdocs\yulog.net.shehua\backadmin/Template/proxy_purview.html" */ ?>
<?php /*%%SmartyHeaderCode:157944ddcbdb0ebbe78-17735822%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a2b5d2b5103ae5b1013d6fe2f13959adea3c76e5' => 
    array (
      0 => 'D:\\htdocs\\yulog.net.shehua\\backadmin/Template/proxy_purview.html',
      1 => 1305853533,
    ),
  ),
  'nocache_hash' => '157944ddcbdb0ebbe78-17735822',
  'function' => 
  array (
  ),
...
<div class="center">
 ...
 echo $_template->getRenderedTemplate();?><?php $_template->updateParentVariables(0);?><?php unset($_template);?>
	...
	<div class="right">
		<div class="Nav">
			<ul>
				<li><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'add','DEL'=>'id'),$_smarty_tpl->smarty,$_smarty_tpl);?>
" <?php echo smarty_function_CLASS_COLOR(array('proxy_purview'=>$_smarty_tpl->getVariable('get')->value['open'],'add'=>$_smarty_tpl->getVariable('get')->value['action'],'CLASS'=>'this'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>添加前台权限</a></li>
				<li><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'show','DEL'=>'id'),$_smarty_tpl->smarty,$_smarty_tpl);?>
" <?php echo smarty_function_CLASS_COLOR(array('proxy_purview'=>$_smarty_tpl->getVariable('get')->value['open'],'show'=>$_smarty_tpl->getVariable('get')->value['action'],'CLASS'=>'this'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>前台权限管理</a></li>
			</ul>
...
?>
					<tr>
						<td align="center"><?php if ($_smarty_tpl->getVariable('pso')->value['is_del']=='Y'){?><input type="checkbox" name="id[]" value="<?php echo $_smarty_tpl->getVariable('pso')->value['id'];?>
" /><?php }else{ ?>-<?php }?></td>
						<td><?php echo $_smarty_tpl->getVariable('pso')->value['open'];?>
</td>
						<td><?php echo $_smarty_tpl->getVariable('pso')->value['open_show'];?>
</td>
						<td><?php echo $_smarty_tpl->getVariable('pso')->value['action'];?>
</td>
						<td><?php echo $_smarty_tpl->getVariable('pso')->value['action_show'];?>
</td>
...
" class="act_5_8" title="编辑"></a></td>
						<td class="action" align="center"><?php if ($_smarty_tpl->getVariable('pso')->value['is_del']=='Y'){?><a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'del','id'=>$_smarty_tpl->getVariable('pso')->value['id']),$_smarty_tpl->smarty,$_smarty_tpl);?>
" class="act_1_5" title="删除"></a><?php }else{ ?>-<?php }?></td>
					</tr>
					<?php }} else { ?>
					<tr><td colspan="7" class="else">当前没有前台权限 , <a href="<?php echo smarty_function_write_url(array('url'=>$_smarty_tpl->getVariable('thisurl')->value,'action'=>'add','DEL'=>'id'),$_smarty_tpl->smarty,$_smarty_tpl);?>
">点击添加前台权限</a></td></tr>
					<?php } ?>
				</table>
				<div class="select">
...
>按 时间 (↓) 排序</option>
					<option value="ORDER=open_UP" <?php echo smarty_function_selected(array('val'=>$_smarty_tpl->getVariable('get')->value['ORDER'],'str'=>'open_UP'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>按 Open (↑) 排序</option>
					<option value="ORDER=open_Dn" <?php echo smarty_function_selected(array('val'=>$_smarty_tpl->getVariable('get')->value['ORDER'],'str'=>'open_Dn'),$_smarty_tpl->smarty,$_smarty_tpl);?>
>按 Open (↓) 排序</option>
				</select>
			</div>
			<?php }?>
