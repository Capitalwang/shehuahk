<?php /* Smarty version Smarty3-b8, created on 2015-09-30 09:58:34
         compiled from "D:\www\shehuahk\wholesale/Template/search_button.html" */ ?>
<?php /*%%SmartyHeaderCode:8270560b41ca8c5ce9-52373700%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cdaad376002862e37b9ba6d4eb1d98d92d0a1c0c' => 
    array (
      0 => 'D:\\www\\shehuahk\\wholesale/Template/search_button.html',
      1 => 1443578200,
    ),
  ),
  'nocache_hash' => '8270560b41ca8c5ce9-52373700',
  'function' => 
  array (
  ),
...
" /></td><th></th>
					...
					<td><?php echo sprintf('%.2f',$_smarty_tpl->getVariable('pso')->value['INTbid']*$_smarty_tpl->getVariable('proxy')->value['mag']*(100+$_smarty_tpl->getVariable('pso')->value['agio']+$_smarty_tpl->getVariable('pso')->value['baseAgio']+$_smarty_tpl->getVariable('pso')->value['promotion_dot'])/100);?>
</td><th></th>
					...
					<?php }else{ ?>
					<td><?php echo sprintf('%.2f',$_smarty_tpl->getVariable('pso')->value['INTbid']*$_smarty_tpl->getVariable('proxy')->value['mag']*(100+$_smarty_tpl->getVariable('pso')->value['agio']+$_smarty_tpl->getVariable('pso')->value['baseAgio']+$_smarty_tpl->getVariable('proxy')->value['rebate'])/100);?>
</td><th></th>
