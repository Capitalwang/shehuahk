	...
	class import extends start
	{
		...
		public function show_exec()
		{
			...
			if ($get['start'] && $get['stop'])
			{
				...
				$post_string = 'username=73826&password=' . urlencode('21212121');
				...
				for ($i = $get['start'] ; $i < $get['stop'] + 0.01 ;)
				{
					...
					$feed_url = 'http://technet.rapaport.com/HTTP/RapLink/download.aspx?ShapeIDs=1&WeightFrom='.$i.'&WeightTo='.$i.'&LabIDs=1,2&CountryIDs=204,217&SortBy=Owner&White=1&Fancy=1&Programmatically=yes&Version=1.0&UseCheckedCulommns=1&cCT=1&cCERT=1&cCLAR=1&cCOLR=1&cCUT=1&cDPTH=1&cFLR=1&cLOTNN=1&cMEAS=1&cPOL=1&cTPr=1&cAct=1&cSHP=1&cSYM=1&cTBL=1&cCertID=1&ticket=' . $auth_ticket;
